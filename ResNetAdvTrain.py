...
###### adversarial training by changing loss function
...
adv_acc = get_adversarial_acc_metric(model, fgsm, fgsm_params)
adv_loss = get_adversarial_loss(model, fgsm, fgsm_params)
model.compile(loss=adv_loss,
...
model.save('cifar_model/resnet/resnet_cifar_fgsm_adv_train_loss3pure7adv_puregenadv_200eps_fulldataset.h5')
